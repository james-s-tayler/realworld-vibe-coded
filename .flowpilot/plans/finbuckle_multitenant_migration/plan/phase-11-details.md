## phase_11: Add E2E Tests for Multi-Tenancy and Cross-Tenant Isolation

### Phase Overview

Add comprehensive E2E tests using Playwright to verify multi-tenancy semantics. Test that users in different organizations cannot see each other's data. Verify articles, comments, tags, and follow relationships are properly scoped to tenants. Uses per-test organization registration from phase 10 for test isolation.
...
- Phase 10 completed (E2E test infrastructure updated for per-test org registration)
...
**Risk 2:** Test setup may be complex with multiple organizations
- **Likelihood:** Low
- **Impact:** Low (test maintenance)
- **Mitigation:** Use helper methods from phase 10 for org registration, keep test setup patterns simple
- **Fallback:** Accept more verbose test setup for comprehensive coverage

### Implementation Steps

**Part 1: Create Multi-Tenancy Test Class**

1. **Create MultiTenancyHappyPathTests class**
...
**Part 2: Add Cross-Tenant Isolation Tests**

2. **Test: Users in different orgs cannot see each other's articles**
   - Use phase 10 helper to register User1 and User2 in separate orgs
   - User1 creates Article1
   - User2 lists articles
...
3. **Test: Users in different orgs cannot see each other's comments**
...
4. **Test: Users in same org can see each other's articles**
...
**Part 3: Add Tag and Profile Isolation Tests**

5. **Test: Tags are scoped to organization**
...
6. **Test: Follow relationships work within organization**
