...
To update the database use this command from the Web project folder (replace `Server` with your project's name):

```powershell
dotnet ef database update -c AppDbContext -p ../Server.Infrastructure/Server.Infrastructure.csproj -s Server.Web.csproj
```
