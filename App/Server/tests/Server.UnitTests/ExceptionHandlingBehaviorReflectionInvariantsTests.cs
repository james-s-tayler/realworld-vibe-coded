...
/// <summary>
/// Tests to validate that CustomArdalisResultFactory methods exist and have the correct signatures.
/// These tests ensure that the factory methods can be used to create Result instances.
/// </summary>
