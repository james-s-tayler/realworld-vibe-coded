...
namespace Server.Infrastructure.Data.Migrations
{
    ...
    [Migration("20260105031340_MoveFollowingAndFavoritesToAuthor")]
    partial class MoveFollowingAndFavoritesToAuthor
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Server.Core.AuthorAggregate.Author", b =>
                {
                    ...
                    b.HasIndex("Username", "TenantId")
                        .IsUnique()
                        .HasDatabaseName("IX_Authors_Username");
            ...
            modelBuilder.Entity("Server.Core.ArticleAggregate.Article", b =>
                {
                    b.HasOne("Server.Core.AuthorAggregate.Author", "Author")
                        .WithMany()
