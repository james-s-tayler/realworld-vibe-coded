...
// @ts-ignore
import { DevOnlyRequestBuilderNavigationMetadata, type DevOnlyRequestBuilder } from './devOnly/index.js';
// @ts-ignore
 ...
 */
export interface ConduitApiClient extends BaseRequestBuilder<ConduitApiClient> {
    /**
     * The api property
     */
    get api(): ApiRequestBuilder;
    /**
     * The devOnly property
     */
    get devOnly(): DevOnlyRequestBuilder;
}
/**
 * Instantiates a new {@link ConduitApiClient} and sets the default values.
 * @param requestAdapter The request adapter to use to execute the requests.
 */
// @ts-ignore
export function createConduitApiClient(requestAdapter: RequestAdapter) {
    ...
    return apiClientProxifier<ConduitApiClient>(requestAdapter, pathParameters, ConduitApiClientNavigationMetadata, undefined);
}
/**
 * Uri template for the request builder.
 */
export const ConduitApiClientUriTemplate = "{+baseurl}";
/**
 * Metadata for all the navigation properties in the request builder.
 */
export const ConduitApiClientNavigationMetadata: Record<Exclude<keyof ConduitApiClient, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    api: {
        navigationMetadata: ApiRequestBuilderNavigationMetadata,
    },
    devOnly: {
        navigationMetadata: DevOnlyRequestBuilderNavigationMetadata,
    },
};
/* tslint:enable */
/* eslint-enable */
