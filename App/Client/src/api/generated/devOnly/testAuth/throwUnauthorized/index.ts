...
/**
 * Builds and executes requests for operations under /dev-only/test-auth/throw-unauthorized
 */
export interface ThrowUnauthorizedRequestBuilder extends BaseRequestBuilder<ThrowUnauthorizedRequestBuilder> {
    /**
     * This endpoint throws an exception due to needing authorization.
 ...
 */
export const ThrowUnauthorizedRequestBuilderUriTemplate = "{+baseurl}/dev-only/test-auth/throw-unauthorized";
/**
 * Metadata for all the requests in the request builder.
 */
export const ThrowUnauthorizedRequestBuilderRequestsMetadata: RequestsMetadata = {
    get: {
        uriTemplate: ThrowUnauthorizedRequestBuilderUriTemplate,
