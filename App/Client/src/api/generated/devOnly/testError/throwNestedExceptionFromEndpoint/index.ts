...
/**
 * Builds and executes requests for operations under /dev-only/test-error/throw-nested-exception-from-endpoint
 */
export interface ThrowNestedExceptionFromEndpointRequestBuilder extends BaseRequestBuilder<ThrowNestedExceptionFromEndpointRequestBuilder> {
    /**
     * This endpoint throws a three-level nested exception directly in the endpoint to test that the global exception handler correctly unwraps inner exceptions.
 ...
 */
export const ThrowNestedExceptionFromEndpointRequestBuilderUriTemplate = "{+baseurl}/dev-only/test-error/throw-nested-exception-from-endpoint";
/**
 * Metadata for all the requests in the request builder.
 */
export const ThrowNestedExceptionFromEndpointRequestBuilderRequestsMetadata: RequestsMetadata = {
    get: {
        uriTemplate: ThrowNestedExceptionFromEndpointRequestBuilderUriTemplate,
