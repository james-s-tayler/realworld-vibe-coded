...
/**
 * Builds and executes requests for operations under /dev-only/test-error/throw-in-use-case
 */
export interface ThrowInUseCaseRequestBuilder extends BaseRequestBuilder<ThrowInUseCaseRequestBuilder> {
    /**
     * This endpoint throws an exception inside the MediatR handler to test exception handling pipeline behavior.
 ...
 */
export const ThrowInUseCaseRequestBuilderUriTemplate = "{+baseurl}/dev-only/test-error/throw-in-use-case";
/**
 * Metadata for all the requests in the request builder.
 */
export const ThrowInUseCaseRequestBuilderRequestsMetadata: RequestsMetadata = {
    get: {
        uriTemplate: ThrowInUseCaseRequestBuilderUriTemplate,
