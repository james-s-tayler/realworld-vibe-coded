...
// @ts-ignore
import { createPaginatedResponseOfUserDtoFromDiscriminatorValue, createProblemDetailsFromDiscriminatorValue, type PaginatedResponseOfUserDto, type ProblemDetails } from '../../models/index.js';
// @ts-ignore
...
export interface UsersRequestBuilder extends BaseRequestBuilder<UsersRequestBuilder> {
     ...
     * @returns {Promise<PaginatedResponseOfUserDto>}
     ...
     */
     get(requestConfiguration?: RequestConfiguration<UsersRequestBuilderGetQueryParameters> | undefined) : Promise<PaginatedResponseOfUserDto | undefined>;
    /**
     * List all users in the system. Authentication required.
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
...
export const UsersRequestBuilderRequestsMetadata: RequestsMetadata = {
    get: {
        ...
        responseBodyFactory:  createPaginatedResponseOfUserDtoFromDiscriminatorValue,
    },
};
/* tslint:enable */
/* eslint-enable */
