...
/**
 * Builds and executes requests for operations under /api/users/{userId}/deactivate
 */
 ...
 */
export const DeactivateRequestBuilderUriTemplate = "{+baseurl}/api/users/{userId}/deactivate";
/**
