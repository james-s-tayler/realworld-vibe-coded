...
// @ts-ignore
import { createArticleResponseFromDiscriminatorValue, createPaginatedResponseOfArticleDtoFromDiscriminatorValue, createProblemDetailsFromDiscriminatorValue, serializeArticleResponse, serializeCreateArticleRequest, type ArticleResponse, type CreateArticleRequest, type PaginatedResponseOfArticleDto, type ProblemDetails } from '../../models/index.js';
// @ts-ignore
...
export interface ArticlesRequestBuilder extends BaseRequestBuilder<ArticlesRequestBuilder> {
     ...
     */
     get(requestConfiguration?: RequestConfiguration<ArticlesRequestBuilderGetQueryParameters> | undefined) : Promise<PaginatedResponseOfArticleDto | undefined>;
    /**
